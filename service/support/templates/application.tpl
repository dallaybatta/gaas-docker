...
topologySpecFactory.localGobblinCluster.specExecutorInstance.class="org.apache.gobblin.service.SimpleKafkaSpecExecutor"
topologySpecFactory.localGobblinCluster.specExecInstance.capabilities="externalSource:InternalSink"
topologySpecFactory.localGobblinCluster.writer.kafka.topic="SimpleKafkaSpecExecutorInstanceTest"
topologySpecFactory.localGobblinCluster.writer.kafka.producerConfig.bootstrap.servers="${KAFKA_BOOTSTRAP_SERVER}"
...
#writer.kafka.topic="SimpleKafkaSpecExecutorInstanceTest"
# Flow Catalog and Store
flowSpec.store.dir=${gobblin.service.work.dir}/flowSpecStore

# Template Catalog
gobblin.service.templateCatalogs.fullyQualifiedPath="${GOBBLIN_SERVICE_TEMPLATE_PATH}"

gobblin.service.port=${GOBBLIN_SERVICE_PORT}
