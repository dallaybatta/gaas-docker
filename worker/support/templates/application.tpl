...
#gobblin.cluster.jobconf.fullyQualifiedPath=/home/vicky/development/gobblin/gobblin-dist-0.13.0/cluster-job-config-bpu1 
gobblin.cluster.jobconf.fullyQualifiedPath=${JOB_CONFIG_PATH}
...
#spec.kafka.topics=SimpleKafkaSpecExecutorInstanceTest
spec.kafka.topics=${KAFKA_TOPIC}

#jobSpecMonitor.kafka.zookeeper.connect="localhost:2181"
jobSpecMonitor.kafka.zookeeper.connect="${ZOOKEEPER_CONNECT_URL}"

specExecInstance.capabilities="externalSource:InternalSink"

#gobblin.cluster.specConsumer.class=org.apache.gobblin.service.SimpleKafkaSpecExecutorInstanceConsumer

#kafka.brokers="localhost:9092"
kafka.brokers="${KAFKA_BROKER_URL}"
...
state.store.zk.connectString="${ZOOKEEPER_CONNECT_URL}"
state.store.type=zk
