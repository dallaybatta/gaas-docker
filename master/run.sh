...
DOCKER_CONTAINER_NAME=docker-gobblin-cluster-master
...
if [ "$2" == "" ]; then
    ...
    JOB_CONFIG_PATH=$GOBBLIN_HOME"/cluster-job-config-bpu1"
fi
...
# This was used for the HDFS based state store.
#HDFS_HOST_PORT=$7
#if [ "$7" == "" ]; then
